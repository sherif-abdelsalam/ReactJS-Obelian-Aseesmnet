    ...
    <div className="covid-stats">
      ...
      <div className="country-selector">
        ...
        <select id="country" onChange={handleCountryChange}>
          ...
          <option value="Aand Islands">Aand Islands</option>
      ...
      {stats && (
        <div className="stats">
          ...
          <div className="stats-row">
            <button>Total Cases: {stats.cases}</button>
            <button>Active Cases: {stats.active}</button>
            <button>Total Deaths: {stats.deaths}</button>
            <button>Total Recovered: {stats.recovered}</button>
          </div>
        </div>
      )}
    </div>
